...
Route::group(['prefix' => 'manage', 'middleware' => ['manageauth', 'RolePermission','systemlog']], function() {
    ...
    Route::post('/expertsEditHandle','ExpertsController@expertsEditHandle')->name('expertsEditHandle');
    Route::get('/expertsEdit/{id}','ExpertsController@expertsEdit')->name('expertsEdit');

    Route::get('/expertsWork/{id}','ExpertsController@expertsWork')->name('expertsWork');
    Route::post('/expertsWorkHandle','ExpertsController@expertsWorkHandle')->name('expertsWorkHandle');
    Route::get('/arbitration','ExpertsController@arbitration')->name('expertArbitration');
    Route::get('/expertsTaskOver/{status}/{id}','ExpertsController@expertsTaskOver')->name('expertsTaskOver');
    Route::get('/expertsDel/{id}','ExpertsController@expertsDel')->name('expertsTaskOver');


    Route::get('/field','FieldController@field')->name('field');
    Route::get('/ajaxSecondField','FieldController@ajaxSecond')->name('field');
    Route::get('/ajaxThirdField','FieldController@ajaxThird')->name('field');
    Route::get('/ajaxFourField','FieldController@ajaxFour')->name('field');
    Route::get('/fieldDel/{id}','FieldController@fieldDel')->name('field');
    Route::post('/fieldCreate','FieldController@fieldCreate')->name('field');

    Route::get('/fastTask','TaskController@fastTask')->name('fastTask');
