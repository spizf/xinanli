...
class WorkModel extends Model
{
    ...
    public $fillable = ['desc','task_id','status','uid','bid_at','created_at','price','workexpert','reviewexpert'];
    ...
    static public function bidDelivery($data)
    {
        $status = DB::transaction(function() use($data){
            ...
            $workInfo = [
                ...
                'forbidden' => 0,
                'uid' => $data['uid'],
                'workexpert' => $data['workexpert'],//add by xl 
                'reviewexpert' => $data['reviewexpert'],
