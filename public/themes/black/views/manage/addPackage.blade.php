                    ...
                    <tbody id="getTr">
                        <tr>
                            <td style="width: 264px">
                                <input type="number" value=""  datatype="*" class="inputxt" name="price_rules[0][time_period]"/> 月
                            </td>
                            <td style="width: 284px">
                                金额：<input type="number"  datatype="*" value=""  class="inputxt" name="price_rules[0][cash]"/> 元
                            </td>
                            <td>
