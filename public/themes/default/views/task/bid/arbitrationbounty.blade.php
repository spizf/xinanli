<div class="col-xs-12 col-left">
    <div class="taskDetails alert taskbg clearfix">
        <div class="page-header">
            <h4 class="text-size22 cor-gray51"><strong>您已选择支付仲裁费！</strong></h4>
        </div>
        ...
        <div class="tabbable">
            ...
            <div class="tab-content clearfix f-tab">
                ...
                <div class="tab-pane in active clearfix text-size14 cor-gray51 u-pay" id="home1">
                    @if($balance_pay)
                        <form class="form-horizontal" role="form" action="/task/arbitrationBountyUpdate" method="post"  name="bounty-form">
                            {{ csrf_field() }}
                ...
                <div class="tab-pane clearfix" id="home2">
                    <form class="form-horizontal" role="form" action="/task/arbitrationBountyUpdate" method="post"  name="bounty-form" target="_blank">
                        {{ csrf_field() }}
                        <input type="hidden" name="id" value="{{ $id }}" />
