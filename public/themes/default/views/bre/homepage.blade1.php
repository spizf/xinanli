...
<div class="col-sm-12 col-left col-right">
    ...
    <div class="addbox">
        <div class="addnewbo">
            <div class="addnewbotop">
                <div class="addnewles on" style="border-left:1px solid #eeeeee;border-right:1px solid #eeeeee;">
                    <span>发需求</span>
                    <b>线上招标轻松省事</b>
                </div>
                        ...
                        <div class="farenwule">
                            <form>
                                {{--<dl>--}}
                                    {{--<dt><i>*</i>项目描述</dt>--}}
                                    {{--<dd>--}}
                                        {{--<textarea id="text" placeholder="一句话描述你的需求（10字以上）" style="width:602px;padding:10px;"></textarea>--}}
                                    {{--</dd>--}}
                                {{--</dl>--}}
                                <dl>
                                    <dt><i>*</i>项目名称</dt>
                                    <dd>
                                        <input id="yusuan" type="text" placeholder="请输入项目名称" style="width:622px;text-indent: 10px;" />
                                    </dd>
                                </dl>
                                <dl>
                                    <dt><i>*</i>地区</dt>
                                    <dd>
                                        ...
                                        {{--<select style="margin-left: 6px;width:204px;">--}}
                                ...
                                {{--<dl>--}}
                                    {{--<dt><i>*</i>项目预算</dt>--}}
                                    {{--<dd>--}}
                                        {{--<input id="yusuan" type="text" placeholder="有明确预算，明确的预算更能吸引服务商参与" style="width:622px;text-indent: 10px;" />--}}
                                    {{--</dd>--}}
                                {{--</dl>--}}
                                <dl>
                                    <dt><i>*</i>生产产品</dt>
                                    <dd>
                                        <input id="lianxi" style="width:315px;" type="text" placeholder="" />
                                    </dd>
                                </dl>
                                <dl>
                                    <dt><i>*</i>年规模/产量</dt>
                                ...
                                <dl>
                                    <dt><i>*</i>联系人</dt>
                                    <dd>
                                        <input id="lianxi" style="width:315px;" type="text" placeholder="联系人姓名" />
                                    </dd>
                                </dl>
                                <dl>
                                    <dt><i>*</i>手机号</dt>
                                    <dd id="yan" style="position: relative;">
                                        <input id="phone" style="width:315px;" type="text" placeholder="请输入手机号" />
    ...
    <script>
        ...
        //获取验证码
        function getqrcoder(iphone, y) {
            var mobilenum = $('#' + iphone).val();
            if(mobilenum == "") {
                layer.msg("手机号不能为空");
                return false;
            };
        ...
        function daojishi(flag, y) {
            var html = '<i id="daojishi" style="position: absolute;right:220px;top:1px;width:86px;height:31px; background:#ddd; display:block;color:#333;font-style:normal;text-align: center;line-height: 31px; font-size:14px">60s</i>';
            $('#' + y).append(html);
            clock = setInterval(doLoop, 1000);
        };

        function doLoop(clock) {
            nums--;
            if(nums > 0) {
                $("#daojishi").text(nums + 's');
                console.log(nums);
            } else {
                clearInterval(clock);
                $("#daojishi").remove();
