...
<div class="g-main">
    ...
    <div class="text-center g-bankhint">
        <img src="{!! Theme::asset()->url('images/sign-icon1.png') !!}"><b>恭喜，企业认证已通过！</b>
    ...
    <div class="space-10"></div>
    <div class="text-size14 cor-gray51 pdl54">企业名称：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="inlineblock cor-gray97">{!! $realname !!} <span class="u-succeedicon">已认证</span></span></div>
    <div class="space-10"></div>
    <div class="text-size14 cor-gray51 pdl54">营业执照编号：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<span class="inlineblock cor-gray97">{!! $card_number !!}</span></div>
    <div class="space-10"></div>
