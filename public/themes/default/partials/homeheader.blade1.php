            ...
            <div class="col-xs-12 col-left col-right">
                ...
                <div class="pull-right">	
                    <ul class="pull-left g-taskbarlist hidden-sm hidden-xs">
                        ...
                        <li class="pull-left g-taskbarli"><a class="g-taskbar2 g-taskbarbor" href="/user/acceptTasksList">我是服务商 <i class="fa fa-caret-down"></i></a>
                            <div class="g-taskbardown1">
            ...
            <div class="col-xs-12 col-left col-right">
                    ...
                    <div class="row">
                        <a href="{!! CommonClass::homePage() !!}">
                            @if(Theme::get('site_config')['site_logo_1'])
                                <img style="display: inline" src="{!! url(Theme::get('site_config')['site_logo_1'])!!}" class="img-responsive wrap-side-img">
                            @else
                                <img style="display: inline"  src="{!! Theme::asset()->url('images/sign-logo.png') !!}" class="img-responsive wrap-side-img">
                            @endif
                        </a>
                ...
                <div class="col-xs-12 hidden-sm visible-xs-block">
                    <div class="text-center">
                        @if(Theme::get('site_config')['site_logo_1'])
                            <img style="display: inline"  src="{!! url(Theme::get('site_config')['site_logo_1'])!!}">
                        @else
                            <img style="display: inline"  src="{!! Theme::asset()->url('images/sign-logo.png') !!}">
                        @endif
                            <img style="margin-top: 5px" src="img/fd_03.jpg">
                    </div>
                </div>
                ...
                <div class="col-lg-5 claerfix hidden-sm hidden-xs hidden-md" style="float: right;">
                    <div class="row">
                        ...
                        <div class="g-taskhdbg2">预付款管理</div>
