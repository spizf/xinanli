                ...
                <table class="" align="left" width="70%">
                    ...
                    <tr>
                        <td style="width: 264px">
                            <input type="number" value="{{$pv['time_period']}}"  datatype="*" class="inputxt" name="price_rules[0][time_period]"/> 月
                        </td>
                        <td style="width: 284px">
                            金额：<input type="number"  datatype="*" value="{{$pv['cash']}}"  class="inputxt" name="price_rules[0][cash]"/> 元
                        </td>
                        @if($pk == 0)
                        <td>
