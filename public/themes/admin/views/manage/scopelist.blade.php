...
<form action="#" method="post">
    {{csrf_field()}}
       ...
       {{-- <div class="well h4 blue">自定义导航</div>--}}
        <h3 class="header smaller lighter blue mg-bottom20 mg-top12">业务范围</h3>
        <div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="hidden-sm hidden-xs btn-group">
                                    <a class="btn btn-xs btn-info" href="/manage/editScope/{!! $item->id !!}">
                                        <i class="fa fa-edit bigger-120"></i>编辑
                                    </a>
                                    <a title="删除" class="btn btn-xs btn-danger" href="/manage/deleteScope/{!! $item->id !!}" >
    ...
    <div class="col-xs-12">
        <div class="dataTables_info row" id="sample-table-2_info">
            <a href="/manage/addScope" class="btn btn-primary btn-sm">添加</a>
        </div>
    </div>
