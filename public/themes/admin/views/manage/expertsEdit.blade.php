...
<form class="form-horizontal clearfix registerform" role="form" enctype="multipart/form-data"  action="{!! url('/manage/expertsEditHandle') !!}" method="post">
	{!! csrf_field() !!}
	<div class="g-backrealdetails clearfix bor-border">
		<div class="bankAuth-bottom clearfix col-xs-12">
			<p class="col-sm-1 control-label no-padding-left" for="form-field-1"> 专家姓名：</p>
			<p class="col-sm-4">
				<input type="text" id="form-field-1"  class="col-xs-10 col-sm-5" name="name" datatype="*2-4" value="{!! $experts->name !!}" nullmsg="请输入专家姓名" errormsg="用户名长度为2到4位字符">
			</p>
		</div>
		<div class="bankAuth-bottom clearfix col-xs-12">
		...
		<div class="bankAuth-bottom clearfix col-xs-12">
			...
			<p class="col-sm-4">
				<img id="head_pic" src="{!! url($experts->head_img) !!}" style="" onmouseleave="toSmall(this)" onmouseenter="toBig(this)" alt="原头像">
			</p>
		</div>
		<script>
			function toBig(obj){
			...
			<p class="col-sm-4">
				<select name="position_level">
					...
					@foreach($position_level as $v)
						<option value="{!! $v->id !!}"
							@if($experts->position_level==$v->id)
							selected
							@endif
						>{!! $v->position_level !!}</option>
					@endforeach
				</select>
			</p>
		</div>
		...
		<div class="bankAuth-bottom clearfix col-xs-12">
			...
			<p class="col-sm-4">
				<input type="text" id="form-field-1"  class="col-xs-10 col-sm-5" value="{!! $experts->year !!}" name="year">
			</p>
		</div>
		<div class="bankAuth-bottom clearfix col-xs-12">
		...
		<div class="bankAuth-bottom clearfix col-xs-12">
			...
			<p class="col-sm-4">
				<input type="text" id="form-field-1"  class="col-xs-10 col-sm-5" value="{!! $experts->level !!}" name="level">
			</p>
		</div>
		<div class="bankAuth-bottom clearfix col-xs-12">
			<p class="col-sm-1 control-label no-padding-left" for="form-field-1"> 推荐指数：</p>
			<p class="col-sm-4">
				<input type="text" id="form-field-1"  class="col-xs-10 col-sm-5" value="{!! $experts->recommend !!}" name="recommend">
			</p>
		</div>
		<div class="bankAuth-bottom clearfix col-xs-12">
			<p class="col-sm-1 control-label no-padding-left" for="form-field-1"> 满意度：</p>
			<p class="col-sm-4">
				<input type="text" id="form-field-1"  class="col-xs-10 col-sm-5" value="{!! $experts->satisfaction !!}" name="satisfaction">
			</p>
		</div>
		<div class="bankAuth-bottom clearfix col-xs-12">
			<p class="col-sm-1 control-label no-padding-left" for="form-field-1"> 咨询量：</p>
			<p class="col-sm-4">
				<input type="text" id="form-field-1"  class="col-xs-10 col-sm-5" value="{!! $experts->ask_num !!}" name="ask_num">
			</p>
		</div>
		<div class="bankAuth-bottom clearfix col-xs-12">
			<p class="col-sm-1 control-label no-padding-left" for="form-field-1"> 服务用户数：</p>
			<p class="col-sm-4">
				<input type="text" id="form-field-1"  class="col-xs-10 col-sm-5" value="{!! $experts->service_num !!}" name="service_num">
			</p>
		</div>
		<div class="bankAuth-bottom clearfix col-xs-12">
			<p class="col-sm-1 control-label no-padding-left" for="form-field-1"> 平均响应时间：</p>
			<p class="col-sm-4">
				<input type="text" id="form-field-1"  class="col-xs-10 col-sm-5" value="{!! $experts->do_time !!}" name="do_time">
			</p>
		</div>
		<div class="bankAuth-bottom clearfix col-xs-12">
			<p class="col-sm-1 control-label no-padding-left" for="form-field-1"> 毕业院校：</p>
			<p class="col-sm-4">
				<input type="text" id="form-field-1"  class="col-xs-10 col-sm-5" value="{!! $experts->un_school !!}" name="un_school">
			</p>
		</div>
		<div class="bankAuth-bottom clearfix col-xs-12">
			<p class="col-sm-1 control-label no-padding-left" for="form-field-1"> 大学专业：</p>
			<p class="col-sm-4">
				<input type="text" id="form-field-1"  class="col-xs-10 col-sm-5" value="{!! $experts->un_learn !!}" name="un_learn">
			</p>
		</div>
		<div class="bankAuth-bottom clearfix col-xs-12">
			...
			<p class="col-sm-4">
				...
				@if($experts->is_show_jigou==1)
					checked
				@endif
				>是
				<input type="radio"  name="is_show_jigou"  value=0
				   @if($experts->is_show_jigou==0)
				   checked
					@endif
				/>否
			</p>
		...
		<div class="bankAuth-bottom clearfix col-xs-12">
			...
			<div class="col-sm-4">
				<p class="input-group input-daterange input-group-sm col-xs-10 col-sm-5">
					<input type="text" class="input-sm form-control hasDatepicker" value="{!! $experts->un_time !!}" name="un_time">
		...
		<div class="bankAuth-bottom clearfix col-xs-12">
			...
			<p class="col-sm-4">
				<input type="text" id="form-field-1"  class="col-xs-10 col-sm-5" value="{!! $experts->un_certificate !!}" name="un_certificate">
			</p>
		</div>
		<div class="bankAuth-bottom clearfix col-xs-12">
			...
			<div class="col-sm-4">
				<p class="input-group input-daterange input-group-sm col-xs-10 col-sm-5">
					<input type="text" class="input-sm form-control hasDatepicker" value="{!! $experts->un_cer_time !!}" name="un_cer_time">
					<span class="input-group-addon">
						<i class="ace-icon fa fa-calendar"></i>
					</span>
				</p>
