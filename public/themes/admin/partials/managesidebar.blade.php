@foreach(Theme::get('manageMenu') as $v)
    <li class="{{ is_array(Theme::get('menu_ids'))&&in_array($v['id'],Theme::get('menu_ids'))?'active':'' }}">
        ...
        <ul class="submenu">
            ...
            <li class="{{ is_array(Theme::get('menu_ids'))&&in_array($value['id'],Theme::get('menu_ids'))?'active':'' }}">
                ...
                <ul class="submenu">
                    ...
                    <li class="{{ is_array(Theme::get('menu_ids'))&&in_array($menus['id'],Theme::get('menu_ids'))?'active':'' }}">
